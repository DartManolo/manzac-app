...
part of 'reporte_salida.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ReporteSalidaAdapter extends TypeAdapter<ReporteSalida> {
  @override
  final typeId = 3;

  @override
  ReporteSalida read(BinaryReader reader) {
    ...
    return ReporteSalida(
      ...
      transporte: fields[20] == null ? "\n" : fields[20] as String?,
      operador: fields[21] == null ? "\n" : fields[21] as String?,
      placas: fields[22] == null ? "\n" : fields[22] as String?,
      licencia: fields[23] == null ? "\n" : fields[23] as String?,
      observaciones: fields[24] == null ? "\n" : fields[24] as String?,
      usuario: fields[25] == null ? "" : fields[25] as String?,
      imagenes:
          fields[26] == null
              ? const []
              : (fields[26] as List?)?.cast<ReporteImagenes>(),
      nombreUsuario: fields[27] == null ? "" : fields[27] as String?,
    )..id = fields[0] as String?;
  }

  @override
  void write(BinaryWriter writer, ReporteSalida obj) {
    writer
      ..writeByte(28)
      ..writeByte(0)
      ..write(obj.id)
